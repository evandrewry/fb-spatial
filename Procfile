...
#     echo '{ "name": "fb-positions", "version": "0.0.1", "dependencies": {} }' >> package.json
#
...
#
#     git checkout deploy
#     git add ./dist/build/fb-positions/fb-positions
#     git commit -m deploy
#
# * push to Heroku
#
...
web: ./dist/build/fb-positions/fb-positions production -p $PORT
